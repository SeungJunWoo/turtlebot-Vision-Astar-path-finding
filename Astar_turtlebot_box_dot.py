...
img = cv2.imread('map4.png',0)

img_buffer1 = cv2.imread('map4.png',0)
img_buffer2 = cv2.imread('map4.png',0)
img_buffer3 = cv2.imread('map4.png',0)
img_buffer4 = cv2.imread('map4.png',0)
img_buffer5 = cv2.imread('map4.png',0)
img_buffer6 = cv2.imread('map4.png',0)
img_buffer7 = cv2.imread('map4.png',0)
img_buffer8 = cv2.imread('map4.png',0)
img_buffer9 = cv2.imread('map4.png',0)
img_buffer10 = cv2.imread('map4.png',0)
img_buffer11 = cv2.imread('map4.png',0)
img_buffer12 = cv2.imread('map4.png',0)
img_buffer13 = cv2.imread('map4.png',0)
img_buffer14 = cv2.imread('map4.png',0)
img_buffer15 = cv2.imread('map4.png',0)
img_buffer16 = cv2.imread('map4.png',0)
img_buffer17 = cv2.imread('map4.png',0)
img_buffer18 = cv2.imread('map4.png',0)
img_buffer19 = cv2.imread('map4.png',0)
img_buffer20 = cv2.imread('map4.png',0)
img_buffer21 = cv2.imread('map4.png',0)
img_buffer22 = cv2.imread('map4.png',0)
img_buffer23 = cv2.imread('map4.png',0)
img_buffer24 = cv2.imread('map4.png',0)
img_buffer25 = cv2.imread('map4.png',0)
img_buffer26 = cv2.imread('map4.png',0)
img_buffer27 = cv2.imread('map4.png',0)
...
class Turtle():
    def __init__(self):
        ...
        turn_cmd = Twist()
        turn_cmd.linear.x = 0.04
        turn_cmd.angular.z = radians(15)

        turn_cmd2 = Twist()
        turn_cmd2.linear.x = 0.04
        ...
        for steps in range(len(direction3)):
            ...
            if direction3[steps][2]%2==0:
                for x in range(0,1*abs(direction3[steps][1])-12):
